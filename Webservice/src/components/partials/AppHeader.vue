  ...
  <b-navbar id="template-header" class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row" toggleable="md">
    <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
      <router-link class="navbar-brand brand-logo" to="/">
        <img class="airbe-logo" src="../../assets/images/airbe/airbe_navbar.png" alt="logo" />
      </router-link>
    </div>
      ...
      <b-navbar-nav class="navbar-nav-right ml-auto">
        ...
        <b-nav-item-dropdown right class="preview-list">
          ...
          <b-dropdown-item class="preview-item py-2 px-0 border-bottom">
            <p class="mb-0 font-weight-medium float-left">You have 2 notifications </p>
          ...
          <b-dropdown-item class="preview-item">
            ...
            <div class="preview-item-content flex-grow py-2">
              <p class="preview-subject ellipsis font-weight-medium text-dark">Nurse Maria</p>
              <p class="font-weight-light small-text"> Question: Blood samples </p>
            </div>
          </b-dropdown-item>
          <b-dropdown-item class="preview-item">
            <div class="preview-thumbnail">
              <img src="../../assets/images/airbe/doctor_profile.jpg" alt="image" class="img-sm profile-pic">
            </div>
            <div class="preview-item-content flex-grow py-2">
              <p class="preview-subject ellipsis font-weight-medium text-dark">Doctor Alex</p>
              <p class="font-weight-light small-text"> Pre-surgery check patient xyz </p>
            </div>
          </b-dropdown-item>
        </b-nav-item-dropdown>
        <b-nav-item-dropdown right class="preview-list">
          ...
          <b-dropdown-item class="preview-item py-2 px-0 border-bottom">
            <p class="mb-0 font-weight-medium float-left">4 new messages </p>
        ...
        <b-nav-item-dropdown right class="preview-list user-dropdown">
          ...
          <b-dropdown-item>
            <div class="dropdown-header text-center w-100">
              <img class="img-md rounded-circle" src="../../assets/images/airbe/doctor_profile.jpg" alt="Profile image">
              <p class="mb-1 mt-3 font-weight-semibold">John Doe</p>
              <p class="font-weight-light text-muted mb-0">Johndoe@mri-clinic.de</p>
            </div>
          </b-dropdown-item>
